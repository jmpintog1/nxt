...
Descarga el archivo de instalación del Fantom Driver y extráelo en una carpeta de tu preferencia. [📥 Descargar Fantom Driver para Windows](./recursos/NXT-Fantom-Drivers-v120.zip)
